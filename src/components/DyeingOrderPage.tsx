...
const DyeingOrderPage: React.FC<DyeingOrderPageProps> = ({ orders, suppliers, products, onAddOrderClick, onPrintClick, onEditOrder, onDeleteOrder }) => {
  ...
  const filteredOrders = orders.filter(
    (ord) =>
      ord.sjNumber.toLowerCase().includes(searchQuery.toLowerCase()) ||
      getSupplierName(ord.supplierId).toLowerCase().includes(searchQuery.toLowerCase()) ||
      getProductName(ord.productId).toLowerCase().includes(searchQuery.toLowerCase()) ||
      ord.color.toLowerCase().includes(searchQuery.toLowerCase())
  );
